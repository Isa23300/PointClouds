...
def main(args):
    ...
    '''CREATE DIR'''
    timestr = 'bs_'+str(datetime.datetime.now().strftime('%Y-%m-%d_%H-%M'))
    exp_dir = Path('./log/')
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            instance_acc, class_acc, every_class_acc  = test(classifier.eval(), testDataLoader, num_class=num_class)
