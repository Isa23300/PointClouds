...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type=str, default='cut1_1024_'+str(datetime.datetime.now().strftime('%Y-%m-%d_%H-%M')), metavar='N', help='Name of the experiment')
    ...
    parser.add_argument('--lr', type=float, default=0.0005, metavar='LR',help='learning rate (default: 0.001, 0.1 if using sgd)')
