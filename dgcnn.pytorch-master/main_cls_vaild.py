...
def train(args, logger):
    ...
    for epoch in range(args.epochs):
        ...
        if test_acc >= best_test_acc and epoch>10:
            ...
            torch.save(model.state_dict(), 'outputs/%s/models/model.t7' % args.exp_name+str(args.lr))
...
def parse_args(x):
    ...
    parser.add_argument('--exp_name', type=str,default='lr_'+str(x) +'_'+ str(datetime.datetime.now().strftime('%Y-%m-%d_%H-%M'))+'_', metavar='N',help='Name of the experiment')
    ...
    parser.add_argument('--lr', type=float, default=x, metavar='LR',
