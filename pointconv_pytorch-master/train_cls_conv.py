...
def main(args):
    ...
    file_dir = Path(str(experiment_dir) + '/stepsize-'+ str(datetime.datetime.now().strftime('%Y-%m-%d_%H-%M')))
    ...
    for epoch in range(start_epoch,args.epoch):
        ...
        print('\r Train Loss: %f' % loss.data)
        logger.info('Train Loss: %f', loss.data)
